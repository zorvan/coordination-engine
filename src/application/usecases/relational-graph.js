const { RelationalEdge } = require('../../domain/entities/relational-edge');
const { RelationalGraph } = require('../../domain/aggregates/relational-graph');
...
module.exports = { RelationalGraphUseCase };
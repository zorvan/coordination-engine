 ...
 */
function createGovernanceRule(ruleId, name, type, content, activatedAt, expiresAt = null) {
  if (!RuleType[type]) {
 ...
 */
function isRuleActive(rule, atDate = new Date()) {
 ...
 */
function willRuleExpire(rule, timeFrameMs) {
